...
SQL;
            ...
            $defaults = [
                ['site_name', 'Akrasia', 'string', 'general'],
                ['site_url', defined('SITE_URL') ? SITE_URL : '', 'string', 'general'],
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { font-size: 1.5rem; margin-bottom: 0.5rem; color: #4e5699; }
        ...
        input:focus { outline: none; border-color: #4e5699; box-shadow: 0 0 0 3px rgba(78,86,153,0.1); }
        button {
            width: 100%; padding: 0.625rem; background: #4e5699; color: #fff; border: none;
            border-radius: 0.375rem; font-size: 1rem; font-weight: 500; cursor: pointer;
            transition: background 0.15s;
        }
        button:hover { background: #3a4175; }
        ...
        .success a { color: #4e5699; font-weight: 500; }
        .warning { background: #fffbeb; border: 1px solid #fde68a; color: #92400e; padding: 1rem; border-radius: 0.375rem; margin-bottom: 1rem; }
        .warning code { background: #fef3c7; padding: 0.1em 0.4em; border-radius: 0.25rem; font-size: 0.9em; }
        .warning ol { margin: 0.5rem 0 0 1.2rem; }
    ...
    <div class="container">
        <div class="card">
            ...
            <?php elseif (!$configExists): ?>
                <div class="warning">
                    <strong>Chybí config.php</strong>
                    <ol>
                        <li>V správci souborů (cPanel) přejděte do <code>/www/akrasia/</code></li>
                        <li>Zkopírujte <code>config.example.php</code> → přejmenujte na <code>config.php</code></li>
                        <li>Otevřete <code>config.php</code> a doplňte DB_HOST, DB_NAME, DB_USER, DB_PASS</li>
                        <li>Uložte a obnovte tuto stránku</li>
                    </ol>
                </div>
            <?php else: ?>
