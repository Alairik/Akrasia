    ...
    return {
        ...
        addBlock(type) {
            var defaults = {
                ...
                'junction':     { title: 'Kdo jste?', subtitle: 'Najděte cestu, která je určena právě vám.', items: [{ variant: 'support', title: 'Hledám podporu', text: '', link_text: 'Zjistit více', link_url: '/hledam-podporu' }, { variant: 'company', title: 'Jsem firma', text: '', link_text: 'Pro zaměstnavatele', link_url: '/pro-firmy' }, { variant: 'school', title: 'Jsem škola', text: '', link_text: 'Pro pedagogy', link_url: '/pro-skoly' }, { variant: 'involve', title: 'Chci se zapojit', text: '', link_text: 'Zapojte se', link_url: '/zapojte-se' }] },
                'testimonials': { title: '', section_class: 'section--mint', prvek: true, photo: 'photo-3.png', items: [{ quote: '', author: '', role: '' }] },
