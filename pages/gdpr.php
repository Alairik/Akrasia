...
<?= deco_html([1,11]) ?>
    <div class="container">
        <div class="page-content-body">
            ...
            <p>Zpracováváme pouze údaje, které nám sami poskytnete:</p>
            <ul>
            ...
            <p>
                ...
                Můžeme je předat důvěryhodným zpracovatelům (poskytovatel webhostingu, e-mailové platformy),
                kteří jsou vázáni mlčenlivostí a zpracovávají data pouze dle našich pokynů.
            </p>
            ...
            <h2>7. Cookies</h2>
            <p>
                Náš web používá technické cookies nezbytné pro správný chod webu. Tyto cookies
                nepotřebují váš souhlas. Nepoužíváme analytické ani marketingové cookies třetích stran.
            </p>
